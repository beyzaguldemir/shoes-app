...
const List = () => {
  ...
  return (
    ...
    <div className="col-span-4 lg:col-span-3">
      {isLoading ? <Loader/> : error ? <Error/> :  data?.length ===0 ? (<p>Aradığınız kriterlere uygun ürün bulunamadı.</p> ) : (<div className="grid grid-cols-2 sm:grid-cols-3 gap-x-4 gap-y-6">
        {data?.map((item)=>(
